...
echo -e -n '\n Please choose a tool from above= ';read tool

case ${tool} in 
   1)	clear	
	while :
	do
	echo -e '\n \e[1;33m WELCOME TO NETWORK SCANNING \n'
	echo -e '\e[0m Select the Type of scan:-'
	echo -e ' 1) Host scan. \n 2) TCP PortScan. \n 3) Service and Version Scan. \n 4) Return to Main Menu.'
	echo -e -n '\n Please enter the option= ';read option 
   ...
   2)	clear
	while :
	do 
	echo -e '\n \e[1;33m WELCOME TO VULNERABILITY SCANNING \n'
	echo -e '\e[0m Choose the Type of scan you want to perform:-'
	...
	2)  clear
		while :
		do  
		echo -e '\n \e[1;33m LOCAL SYSTEM SCANNING \n'
		echo -e '\e[0m Please choose the scan you want to perform:-'
		...
		case ${option} in
		1)	clear
			sudo python3 vulmap.py -v 
			echo -e ' \n !!DONE!! \n '		
		;;
		2)	clear
			sudo python3 vulmap.py -o 		 
			echo -e ' \n !!DONE!! \n '
		;;
		3)	clear
			break			 
   ...
   ;;
   3) clear
	echo -e '\e[41mSTART EXPLOITING?'
	while :
	do
	echo -e -n '\e[0m\nPRESS 1 to start OR PRESS 2 to go back=';read option
